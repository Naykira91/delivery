...
const cardsRestaurants = document.querySelector('.cards-restaurants'); //day 2
...
let login = localStorage.getItem('nameDelivery');
...
function notAuthorized () {
  ...
  function logIn(event) {
    ...
    if (maskInput(loginInput.value)){
      ...
      localStorage.setItem('nameDelivery', login);
      toggleModalAuth();
